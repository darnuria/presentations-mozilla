...
Présentation donnée à Lyon Dimanche 18 Novembre 2012 pendant les Journées du Logiciel Libre.  
...
Cette présentation est sous licence CC-BY-SA 3.0 ce qui signifie que vous pouvez librement la réutiliser à condition de mentionner l'auteur (Flaburgan) et de faire un lien vers cette page. De plus, les documents dans lesquels vous utiliserez tout ou partie de cette présentation devront être sous cette même licence.
